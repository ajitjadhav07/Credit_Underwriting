...
function buildTokenMap(assessment) {
    ...
    return {
        ...
        CUSTOMER_DETAILS:    orEmpty(cust.customerCode || cust.custCif),
        ...
        RATING:              'Internal: ' + orBlank(cust.internalRating) + '  External: ' + orBlank(cust.externalRating),
        FACILITY_TYPE:       orBlank(loan.loanType),
