...
class DocxGenerator {
    ...
    generateAflCamSection(assessment) {
        ...
        if (rps.length) {
            ...
            // Sample shows the note paragraph AND an empty 8-row table under the header
            out.push(new Paragraph({
                spacing: { before: 40, after: 40 },
            ...
            for (let i = 0; i < 8; i++) {
                rpsRows.push(new TableRow({ children: [
                    dataCell3('', 1800, AlignmentType.CENTER),
                    dataCell3('', 1900, AlignmentType.CENTER),
                    dataCell3('', 1832, AlignmentType.RIGHT),
                    dataCell3('', 1832, AlignmentType.RIGHT),
                    dataCell3('', 1832, AlignmentType.RIGHT),
                ]}));
            }
