...
class CalculationEngine {
    ...
    calculateAll(extractedData) {
        ...
        // CIBIL data fetched via NSDL/CIBIL Middleware integration (external-apis-manager.js)
        // Falls back gracefully to null if external verification wasn't run/configured.
        const cibilData = extractedData.external_verification?.cibil?.success
            ? extractedData.external_verification.cibil
            : null;
