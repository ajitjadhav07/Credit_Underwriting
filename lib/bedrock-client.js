...
// NOTE on data residency: Sonnet 4.6 has no India in-region option and no
// broad "apac." cross-region profile — only "jp." (Japan) or "global."
// (worldwide) inference profiles exist for this model. The CloudFormation
// BedrockModelId parameter (which always overrides this default at
// runtime) currently uses "jp.anthropic.claude-sonnet-4-6". Confirm with
// compliance whether routing Indian borrower financial data through Japan
// is acceptable before relying on this in production.
const DEFAULT_MODEL_MAP = {
    'claude-sonnet-4-20250514': process.env.BEDROCK_MODEL_ID || 'jp.anthropic.claude-sonnet-4-6'
};
