...
const API_SIGNATURES = [
    {
        ...
        // Fields that must be present & non-empty for the uploaded file to be
        // considered "complete" — otherwise fall back to calling the API.
    ...
    },
    {
        ...
        requiredFields: [],  // Novel analysis output shape TBD — accept any for now
    },
    // When AFL provides the full API list, add one entry per API here.
    // Nothing else in the codebase needs to change per API.
];
