...
// Default to IP directly — AFL hostname (afloasuatweb.axisb.com) does not
// resolve from inside the VPC (no Route53 Private Hosted Zone configured).
// Using IP bypasses DNS entirely. NODE_TLS_REJECT_UNAUTHORIZED=0 is set in
// server.js to handle the cert/hostname mismatch when connecting via IP.
const PENNANT_BASE_URL = process.env.PENNANT_BASE_URL || 'https://10.0.252.13:8070';
