...
const API_REGISTRY = {
    ...
    gst_auth: {
        ...
        url: `${MIDDLEWARE_DATAPOWER}/V1/Karza/GST/gstdetailed`,
        serviceCode: 'GSTDETAILED',
    },
    gst_return: {
        key: 'gst_return', name: 'GST Return Filing', method: 'middleware',
        url: `${MIDDLEWARE_DATAPOWER}/V1/Karza/GST/gst-return-status`,
        serviceCode: 'GSTRETURN',
    },
    peer_comparison: {
        key: 'peer_comparison', name: 'Peer Comparison', method: 'middleware',
        url: `${MIDDLEWARE_DATAPOWER}/V1/Karza/kscan/peer-details`,
        serviceCode: 'PEERDETAILS',
    },
    fir: {
