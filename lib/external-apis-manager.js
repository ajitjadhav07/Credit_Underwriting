...
const CIBIL_COMMERCIAL_BASE_URL = process.env.MIDDLEWARE_CIBIL_COMMERCIAL_URL || 'https://aflmiddlepower.axisb.com:8441';
const NOVEL_UPLOAD_BASE_URL = process.env.MIDDLEWARE_NOVEL_UPLOAD_URL || 'https://aflmiddlepower.axisb.com:8446';
const NOVEL_BASE_URL = process.env.MIDDLEWARE_NOVEL_URL || 'https://aflmiddlepower.axisb.com:8446';
