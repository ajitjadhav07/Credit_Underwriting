 ...
 *
 * GATEWAYS (confirmed from the provided collections):
 *   - DataPower Middleware  -> Karza ITR, Karza EPFO (UAN OTP/Auth)
 *       https://afldatapoweruat.axisb.com:8441/V1/Karza/...
 *   - Internal gateway      -> CIBIL Commercial, Novel (bank statements)
 *       http://10.0.218.39:708x/V1/...
 *
...
const CIBIL_COMMERCIAL_BASE_URL = process.env.MIDDLEWARE_CIBIL_COMMERCIAL_URL || 'http://10.0.218.39:7083';
const NOVEL_UPLOAD_BASE_URL = process.env.MIDDLEWARE_NOVEL_UPLOAD_URL || 'http://10.0.218.39:7084';
const NOVEL_BASE_URL = process.env.MIDDLEWARE_NOVEL_URL || 'http://10.0.218.39:7083';
