...
const DATAPOWER_BASE_URL        = process.env.MIDDLEWARE_DATAPOWER_URL          || 'https://192.168.127.69:8441';
const CIBIL_COMMERCIAL_BASE_URL = process.env.MIDDLEWARE_CIBIL_COMMERCIAL_URL   || 'https://192.168.127.69:8441';
const NOVEL_UPLOAD_BASE_URL     = process.env.MIDDLEWARE_NOVEL_UPLOAD_URL        || 'https://192.168.127.69:8446';
const NOVEL_BASE_URL            = process.env.MIDDLEWARE_NOVEL_URL               || 'https://192.168.127.69:8446';
